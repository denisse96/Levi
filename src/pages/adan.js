    ...
    <Grommet>
      <Box margin={{ horizontal: 'auto' }} >
        <Box margin="auto" direction="column" alignContent="center" background="f7f6f6" gap="large">
          ...
          {mision1 == true ? <Heading color="blue" margin={{ horizontal: 'auto' }} level={3} textAlign="center">
            {label}
          </Heading> : <Heading color="lightRed" margin={{ horizontal: 'auto' }} level={3} textAlign="center">
              ¡Ayúdame a conocer Scratch!
        </Heading>}
        <Box  height="large" width='medium' background="url(https://scratch-diplomas-wizeline.s3.us-east-2.amazonaws.com/aus.png)"></Box>
          {mision1 &&
            <>
...

          {
            ...
            <Button primary target="_blank" label="¡Listo!" href="https://scratch-diplomas-wizeline.s3.us-east-2.amazonaws.com/Adan.pdf" onClick={() => {
                    setScore((score) => (score + 10000))
